...
_TASK_PATH = os.path.expanduser('~/.scendroid_default.textproto')
...
class ScenDroidController(base_wrapper.BaseWrapper):
...
def get_controller(
  ...
  logging.info('Setting up ScenDroidController.')
  return ScenDroidController(android_env_instance)
