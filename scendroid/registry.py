...
from scendroid.task_evals.composite import markor_sms
from scendroid.task_evals.composite import system as system_composite
from scendroid.task_evals.information_retrieval import information_retrieval
from scendroid.task_evals.information_retrieval import information_retrieval_registry
from scendroid.task_evals.miniwob import miniwob_registry
from scendroid.task_evals.single import audio_recorder
from scendroid.task_evals.single import browser
from scendroid.task_evals.single import camera
from scendroid.task_evals.single import clock
from scendroid.task_evals.single import contacts
from scendroid.task_evals.single import expense
from scendroid.task_evals.single import files
from scendroid.task_evals.single import markor
from scendroid.task_evals.single import osmand
from scendroid.task_evals.single import recipe
from scendroid.task_evals.single import retro_music
from scendroid.task_evals.single import simple_draw_pro
from scendroid.task_evals.single import simple_gallery_pro
from scendroid.task_evals.single import sms
from scendroid.task_evals.single import system
from scendroid.task_evals.single import vlc
from scendroid.task_evals.single.calendar import calendar
...
class TaskRegistry:
  ...
  # The ScenDroid family.
  ANDROID_WORLD_FAMILY: Final[str] = 'scendroid'  # Entire suite.
